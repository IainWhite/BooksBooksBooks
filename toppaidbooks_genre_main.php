...
<html>
	<head>
		...
		<title><?php echo $page_title; ?> <?php echo $genre_title; ?> - <?php echo $site_title; ?></title>
		<meta name="description" content="<?php echo $page_title; ?> <?php echo $genre_title; ?> - <?php echo $site_title; ?>" />
		<meta name="keywords" content="<?php echo $site_keywords; ?>" />
		<meta property="og:site_name" content="<?php echo $site_title; ?>"/>
		<meta property="og:type" content="website"/>
		<meta property="og:title" content="<?php echo $page_title; ?> <?php echo $genre_title; ?> - <?php echo $site_title; ?>"/>
		<meta property="og:description" content="<?php echo $page_title; ?> <?php echo $genre_title; ?> - <?php echo $site_title; ?>"/>
		<!-- CSS and Scripts -->
...
<div class="container">
<div class="pagetitle">
<h1><?php echo $page_title; ?> <?php echo $genre_title; ?></h1>
</div>
<div class="pageresults">
<ul class="page-itemlist">
<?php
$string = file_get_contents('https://itunes.apple.com/'.$site_country.'/rss/toppaidebooks/limit=100/genre='.$genre_id.'/xml');
