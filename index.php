...
<ul>
<?php
if (!empty($homebooks_genre_id)) {
$string = file_get_contents('https://itunes.apple.com/'.$site_country.'/rss/toppaidebooks/limit=10/genre='.$homebooks_genre_id.'/xml');
}
else {
$string = file_get_contents('https://itunes.apple.com/'.$site_country.'/rss/toppaidebooks/limit=10/xml');
}
...
foreach ($xml->entry as $val) {
    ...
    $rssresults .= '<li><div class="homethumb"><a href="'.$site_url.'/book/'.$musicid[0].'/'.cano($val->imname).'"><img src="'.$bigimage.'" alt="" width="180px" height="270px" ><span class="overlay"><p>'.$val->imname.' - '.$val->impublisher.'</p></span></a></div></li>';
